...
<div id="container">
	<div id="header">
		New Process Instance: /testproject/src/main/resources/myteam/testproject.testprocess
	</div>
	<div id="content">
		...
		<fieldset>
            <legend>Process inputs</legend>
                            		...
                            		<div class="div_texbox">
                              		<input name="integer" type="text" class="textbox" id="integer" value="" />
                            		</div>
              	
                            		<label for="name">boolean</label>
                            		<div class="div_checkbox">
                              		<input name="boolean" type="checkbox" class="checkbox" id="boolean" value="true" />
                            		</div>
              	
                            		<label for="name">float</label>
                            		<div class="div_texbox">
                              		<input name="float" type="text" class="textbox" id="float" value="" />
                            		</div>
              	
                            		<label for="name">String</label>
                            		<div class="div_texbox">
                              		<input name="String" type="text" class="textbox" id="String" value="" />
                            		</div>
              	
                            		<label for="name">Object</label>
                            		<div class="div_texbox">
                              		<input name="Object" type="text" class="textbox" id="Object" value="" />
                            		</div>
